...
def cli_main():
    ...
    print(args)
    train_dataset = CSVImageDatasets(args.train_csv, args.data_root, transform=[torchvision.transforms.Resize((64,64))])
    val_dataset = CSVImageDatasets(args.val_csv, args.data_root, transform=[torchvision.transforms.Resize((64,64))])
